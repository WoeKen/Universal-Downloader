/**
 * EasyQRCodeJS / QRCode.js - Standard Compliant Standalone QR Code Engine
 * Supports Mode 8-bit Byte, Reed-Solomon EC (L, M, Q, H), Auto-version (1-40)
 */
(function (global, factory) {
    ...
    make: function () {
      if (this.typeNumber < 1) {
        ...
        for (typeNumber = 1; typeNumber < 40; typeNumber++) {
          ...
          if (length + 4 <= totalDataCount * 8) break;
        }
        this.typeNumber = typeNumber;
      }
  ...
  function QRCode(target, vOption) {
    var options = {
      width: 256,
      height: 256,
      typeNumber: 4,
    ...
    if (typeof vOption === 'string') options.text = vOption;
    else if (vOption) for (var k in vOption) options[k] = vOption[k];
  ...
  QRCode.prototype.makeCode = function (sText) {
    ...
    if (canvas.tagName !== 'CANVAS') {
      ...
      newCanvas.width = this._htOption.width;
      newCanvas.height = this._htOption.height;
